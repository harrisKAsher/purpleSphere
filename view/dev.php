...
<div id="admin_post">
    <form action="." method="post">
        ...
        <input type="text" name="link_path" /><br />
...
<div class="panel-body">
     <div class="panel"><br>
        ...
        <div class="col-xs-0 col-lg-1"></div>
            ...
            <div class="col-xs-12 col-lg-5 textCenter"><h1>Prison to Prison</h1><p>A website I deigned for my web design class in the fall of 2015. The website was made using HTML, CSS, Bootstrap, JavaScript, jQuery and PHP. I was required to make it in 8 days and was not allowed to work with others on the project. I used Illustrator to make the design of the prisons that is used as the logo and Brackets to make the website.</p>
         ...
         <p>Check it out here: <a href="/web_sites/p2p/">Prison to Prison Triathlon</a></p><br />
                ...
                <?php if (isset($_SESSION['usertype'])) {
                        if ($_SESSION['usertype'] == 'admin' || $_SESSION['usertype'] == 'user') { ?>
                            <div class="move_right">
                                <a onclick="comment_post_display()" class="clickme">
                                    New Comment</a> |
                ...
                <div class="comment_display">
                    <form action="." method="post">
                        <input type="hidden" name="action" value="submitCom" />
                        <input type="hidden" name="userID" value='<?php echo $_SESSION['userID'] ?>' />
